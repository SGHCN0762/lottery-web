<template>
  <div class="classical-poems-page">
    ...
    <div v-else class="page-content">
      <div class="page-header">
        <div class="stats-bar">
          <div class="stat-item">
            ...
            <span class="stat-label">总诗词</span>
          </div>
      ...
      <div class="items-list">
        ...
        <div v-else class="empty-tip">
          <van-empty description="没有找到相关诗词" />
        </div>
      </div>
    </div>
...
const goToLearn = () => {
  router.push('/tools/classical-poems/learn');
};

const goToPractice = () => {
  router.push('/tools/classical-poems/practice');
};
