    ...
    <div v-else class="learn-content">
      ...
      <div v-if="!learnStarted" class="start-screen">
        ...
        <div class="stage-selector">
          ...
          >
            ...
            <span class="stage-count">{{ getStageCount(key) }} 首</span>
          </div>
        </div>
      ...
      <div v-else class="learn-card-container" v-if="currentItem">
        <div class="learn-card">
          <div class="card-type-badge">古诗词</div>
...
import { useClassicalPoems } from '../hooks/useClassicalPoems';

const router = useRouter();
const { allItems, loading, markMastered, isMastered } = useClassicalPoems();
