...
const LEARNED_KEY = 'classical_essays_learned_ids';
const MASTERED_KEY = 'classical_essays_mastered_ids';
const FAVORITE_KEY = 'classical_essays_favorite_ids';
const PRACTICE_RECORDS_KEY = 'classical_essays_practice_records';
...
export function useClassicalEssays() {
