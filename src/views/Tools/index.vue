...
const tools = computed(() => [
  ...
  {
    id: 'famous-quotes',
    name: t('tools.famousQuotes.name'),
    icon: '💬',
    description: t('tools.famousQuotes.description'),
    route: 'FamousQuotes',
  },
  {
    id: 'classical-poems',
    name: t('tools.classicalPoems.name'),
    icon: '📜',
    description: t('tools.classicalPoems.description'),
    route: 'ClassicalPoems',
  },
  {
    id: 'classical-essays',
    name: t('tools.classicalEssays.name'),
    icon: '📖',
  ...
  {
    id: 'laws-regulations',
    name: t('tools.lawsRegulations.name'),
    icon: '⚖️',
    description: t('tools.lawsRegulations.description'),
    route: 'LawsRegulations',
  },
  {
