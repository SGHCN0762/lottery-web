    ...
    <div v-else class="page-content">
      <div class="page-header">
        <div class="stats-bar">
          <div class="stat-item">
            ...
            <span class="stat-label">总名言</span>
          </div>
      ...
      <div class="items-list">
        ...
        <div v-else class="empty-tip">
          <van-empty description="没有找到相关名言" />
        </div>
      </div>
    </div>
...
const goToLearn = () => {
  router.push('/tools/famous-quotes/learn');
};

const goToPractice = () => {
  router.push('/tools/famous-quotes/practice');
};
