  ...
  <div class="practice-page">
    ...
    <div v-else class="practice-content">
      <div v-if="!practiceStarted" class="start-screen">
        ...
        <p class="start-desc">选择练习类型，巩固所学名言</p>
...
const { allItems, loading, markMastered, recordPractice } = useFamousQuotes();
  ...
  for (let i = 0; i < questionCount; i++) {
    ...
    if (selectedType.value === 'choice') {
      ...
      if (rand > 0.5) {
        ...
        questionList.push({
          type: 'authorMatch',
          question: `"${truncateContent(item.content, 30)}"这句名言的作者是谁？`,
          options,
          correctIndex,
          correctAnswer,
          author: item.author,
