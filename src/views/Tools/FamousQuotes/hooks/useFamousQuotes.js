...
const LEARNED_KEY = 'famous_quotes_learned_ids';
const MASTERED_KEY = 'famous_quotes_mastered_ids';
const FAVORITE_KEY = 'famous_quotes_favorite_ids';
const PRACTICE_RECORDS_KEY = 'famous_quotes_practice_records';
...
export function useFamousQuotes() {
