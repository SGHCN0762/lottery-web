    ...
    <div class="learn-content" v-if="currentPoint">
      ...
      <div class="nav-buttons">
        ...
        >
          ...
          {{ isMastered(currentPoint.id) ? t('tools.biology.actions.unmarkMaster') : t('tools.biology.actions.markMaster') }}
        </van-button>
        <van-button
          :disabled="isLast"
          type="primary"
