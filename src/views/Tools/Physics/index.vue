    ...
    <div v-else class="page-content">
      <div class="page-header">
        <div class="stats-bar">
          <div class="stat-item">
            ...
            <span class="stat-label">{{ t('tools.physics.stats.total') }}</span>
          </div>
          <div class="stat-divider"></div>
          <div class="stat-item">
            <span class="stat-value learned">{{ learnedCount }}</span>
            <span class="stat-label">{{ t('tools.physics.stats.learned') }}</span>
          </div>
          <div class="stat-divider"></div>
          <div class="stat-item">
            <span class="stat-value mastered">{{ masteredCount }}</span>
            <span class="stat-label">{{ t('tools.physics.stats.mastered') }}</span>
          </div>
        </div>
      ...
      <div class="search-section">
        <van-search
          ...
          :placeholder="t('tools.physics.searchPlaceholder')"
          shape="round"
        />
      </div>
      ...
      <div class="mode-buttons">
        <button class="mode-btn learn-btn" @click="goToLearn">
          <div class="mode-btn-content">
            ...
            <div class="mode-text-group">
              <span class="mode-title">{{ t('tools.physics.modes.learn') }}</span>
              <span class="mode-desc">{{ t('tools.physics.modes.learnDesc') }}</span>
            </div>
          </div>
        </button>
        <button class="mode-btn practice-btn" @click="goToPractice">
          <div class="mode-btn-content">
            ...
            <div class="mode-text-group">
              <span class="mode-title">{{ t('tools.physics.modes.practice') }}</span>
              <span class="mode-desc">{{ t('tools.physics.modes.practiceDesc') }}</span>
            </div>
          </div>
        </button>
      </div>
      ...
      <div class="items-list">
        ...
        <div v-else class="empty-tip">
          <van-empty :description="t('tools.physics.empty')" />
        </div>
      </div>
    </div>
