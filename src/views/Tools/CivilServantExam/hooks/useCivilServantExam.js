...
const PROVINCE_XINGCE_JSON_CDN_URL = 'https://cdn.jsdelivr.net/gh/SGHCN0762/civil-provice-exam-xingce-json@v1.0.0/';
const PROVINCE_SHENLUN_JSON_CDN_URL = 'https://cdn.jsdelivr.net/gh/SGHCN0762/civil-provice-exam-shenlun-json@v1.0.0/';
const COUNTRY_XINGCE_JSON_CDN_URL = 'https://cdn.jsdelivr.net/gh/SGHCN0762/civil-country-exam-xingce-json@v1.0.0/';
const COUNTRY_SHENLUN_JSON_CDN_URL = 'https://cdn.jsdelivr.net/gh/SGHCN0762/civil-country-exam-shenlun-json@v1.0.0/';
...
export const getProvinceXingceJsonUrl = fileName => `${PROVINCE_XINGCE_JSON_CDN_URL}${encodeURIComponent(fileName)}`;
export const getProvinceShenlunJsonUrl = fileName => `${PROVINCE_SHENLUN_JSON_CDN_URL}${encodeURIComponent(fileName)}`;
export const getCountryXingceJsonUrl = fileName => `${COUNTRY_XINGCE_JSON_CDN_URL}${encodeURIComponent(fileName)}`;
export const getCountryShenlunJsonUrl = fileName => `${COUNTRY_SHENLUN_JSON_CDN_URL}${encodeURIComponent(fileName)}`;
