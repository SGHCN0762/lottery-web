...
export default {
  ...
  quizChallenge: {
    ...
    selectCategory: '選擇挑戰分類（可多選）',
    selectCount: '選擇題目數量',
    correct: '答對',
    wrong: '答錯',
    questionNavigation: '題目導航',
    unanswered: '未作答',
    loadError: '載入題目失敗',
    rules: {
      title: '遊戲規則',
      rule1: '可選擇多個技術分類進行挑戰',
      rule2: '可自定義挑戰題目數量（5-50題）',
      rule3: '每答對一題獲得5積分，連續答對有額外獎勵',
      rule4: '連續答對獎勵：2題+5分，3題+10分，4題+15分，5題及以上+25分',
    },
  },
  ...
  quizChallenge: {
    ...
    completed: '挑戰完成',
    tryAgain: '再來一次',
    success: '恭喜！本局獲得 {points} 積分',
    loadError: '載入題目失敗，請重試',
    bonus: '太棒了！連續答對 {count} 題，額外獎勵 {bonus} 積分',
    wrongAnswer: '回答錯誤，繼續加油！',
    rules: {
      title: '遊戲規則',
      rule1: '選擇你擅長的技術分類',
      rule2: '每題答對可獲得基礎積分',
