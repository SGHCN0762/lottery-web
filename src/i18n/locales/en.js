...
export default {
  ...
  lottery: {
    ...
    numberGuessDesc: 'Guess the random number, test your luck',
    luckyWheelDesc: 'Spin the wheel, win generous points',
    quizChallengeDesc: 'Answer fun questions, show your knowledge',
    dailyCheckInDesc: 'Log in daily to collect points',
  ...
  badges: {
    ...
    claim: 'Claim',
    claimed: 'Claimed',
    badgeEarned: 'Achievement Earned',
  ...
  invite: {
    ...
    shareText: 'Join Yaoguang Realm and play games to earn points! Use my invite code: {code}',
  ...
  exchange: {
    ...
    exchangeConfirm: 'Are you sure to exchange this product? It will cost {points} points',
    myOrders: 'My Orders',
  ...
  help: {
    ...
    tip: 'Tip: This platform is for entertainment only, please participate rationally and do not become addicted. If you have any questions, please contact customer service.',
    onlineService: {
      title: 'Online Service',
      serviceHours: 'Service Hours: 9:00 - 22:00',
      ...
      workingHoursValue: 'Monday to Sunday 9:00-22:00',
      tip: 'Tip: For urgent matters, please call customer service directly. We will respond to you as soon as possible during working hours.',
      averageResponseTime: 'Average response time: 2 minutes',
      clearHistory: 'Clear History',
      startChatHint: 'Start chatting with customer service',
      inputPlaceholder: 'Please enter your question...',
      send: 'Send',
      onlineStatus: 'Online Service',
      ...
      quickQuestions: {
        rechargePoints: 'How to recharge points?',
    ...
    pointsPopup: {
      ...
      earn: {
        ...
        items: [
          'Daily check-in: 10 base points, with additional rewards for consecutive check-ins',
    ...
    accountHelp: 'Account Issues',
    paymentHelp: 'Payment Issues',
    ...
    chatWithService: 'Chat with Service',
  ...
  numberGuess: {
    title: 'Number Guess',
    startDesc: 'Test your luck and intuition!',
    remainingAttempts: 'Remaining Attempts',
    myPoints: 'My Points',
    startGame: 'Start Game',
    inputLabel: 'Please enter your guess (1-100)',
    inputPlaceholder: 'Enter a number between 1-100',
    processing: 'Verifying...',
    submitGuess: 'Submit Guess',
    winMessage: 'Congratulations, you guessed it!',
    loseMessage: 'Sorry, you ran out of attempts',
    reward: 'Earned {points} points!',
    correctAnswer: 'The correct answer is: {number}',
    playAgain: 'Play Again',
    successToast: 'Congratulations! Earned {points} points',
    failToast: 'You ran out of attempts, try again!',
    rules: {
      title: 'Game Rules',
  ...
  luckyWheel: {
    ...
    insufficientPoints: 'Insufficient points, need 10 points',
  ...
  quizChallenge: {
    ...
    startDesc: 'Show your technical knowledge!',
    myPoints: 'My Points',
    ...
    progress: 'Progress',
    streak: 'Consecutive correct answers: {count}',
    correctCount: 'Correct Answers',
    earnedPoints: 'Earned Points',
    maxStreak: 'Highest Streak',
    bonus: 'Excellent! {count} consecutive correct answers, bonus {bonus} points',
    wrongAnswer: 'Wrong answer, keep trying!',
  ...
  dailyCheckIn: {
    myPoints: 'My Points',
    consecutiveDays: 'Consecutive Check-ins',
    days: 'days',
    rules: {
      title: 'Game Rules',
  ...
  about: {
    ...
    health: {
      ...
      timeTip: 'Recommended daily gaming time: no more than 2 hours',
