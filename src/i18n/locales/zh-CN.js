...
export default {
  ...
  lottery: {
    ...
    quizChallenge: '答题挑战',
    dailyCheckIn: '每日签到',
    numberGuessDesc: '猜测随机数字，考验你的运气',
    luckyWheelDesc: '转动转盘，赢取丰厚积分',
    quizChallengeDesc: '回答趣味问题，展示知识',
    dailyCheckInDesc: '每天登录即可领取积分',
  ...
  numberGuess: {
    title: '数字猜猜猜',
    startDesc: '考验你的运气和直觉！',
    remainingAttempts: '剩余机会',
    myPoints: '我的积分',
    startGame: '开始游戏',
    inputLabel: '请输入你的猜测 (1-100)',
    inputPlaceholder: '输入1-100的数字',
    processing: '验证中...',
    submitGuess: '提交猜测',
    winMessage: '恭喜你，猜对了！',
    loseMessage: '很遗憾，机会用完了',
    reward: '获得 {points} 积分！',
    correctAnswer: '正确答案是：{number}',
    playAgain: '再来一局',
    successToast: '恭喜！获得 {points} 积分',
    failToast: '机会用完了，再试一次吧！',
    rules: {
      title: '游戏规则',
  ...
  luckyWheel: {
    ...
    cost: '抽奖消耗',
    start: '开始抽奖',
    insufficientPoints: '积分不足，需要10积分',
    won: '恭喜获得 {prize}！',
    history: '抽奖记录',
    rules: {
      title: '游戏规则',
  ...
  newYearEve: {
    ...
    customs: {
      doorGod: '贴门神',
      doorGodDesc: '在门上贴上门神画像，寓意驱邪避灾，保佑家人平安',
      firecrackers: '放鞭炮',
      firecrackersDesc: '燃放鞭炮，辞旧迎新，驱赶年兽，带来好运',
      dumplings: '吃饺子',
    ...
    foods: {
      fish: '年夜鱼',
      fishDesc: '年年有余，象征富足和丰收',
      dumplings: '饺子',
      dumplingsDesc: '形似元宝，寓意招财进宝',
      riceCake: '年糕',
